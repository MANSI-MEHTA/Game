	...
	<h1></h1>
		...
		<div class="container">
			...
			<div class="product">
					...
					<iframe width="700" height="345" src="https://www.youtube.com/embed/SX2ApPUn05c" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
<br>
					...
					<div class="accordion-image">
								<div class="ac-img">
									<img width="250" height="200" src="images/WWE1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img width="250" height="200" src="images/WWE2.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div>
	</div>
