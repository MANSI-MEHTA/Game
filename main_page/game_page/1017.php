...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Call of Duty: Advanced Warfare</h1>

			<div class="product">
				
				    <iframe width="680" height="345" src="https://www.youtube.com/embed/sFu5qXMuaJU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.in/Call-Duty-Advanced-Warfare-PS4/dp/B00P2CK5VU" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
...
Advanced Warfare is Sledgehammer's first Call of Duty title where they are the primary developer, following the supporting work they did on Call of Duty: Modern Warfare 3 alongside Infinity Ward in 2011.</p>
<br>
					<div>
					...
					<div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="images/CoDaw1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="images/CoDaw2.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div>
	</div>
