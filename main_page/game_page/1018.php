...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Titanfall</h1>

			<div class="product">
			
				    <iframe width="680" height="345" src="https://www.youtube.com/embed/N1vqjJRcCzg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.in/Electronic-Arts-81386-Titanfall-Xbox/dp/B00D781WO0" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p>Titanfall is a multiplayer first-person shooter video game developed by Respawn Entertainment and published by Electronic Arts. It was released for Microsoft Windows and Xbox One on March 11, 2014; an Xbox 360 version ported by Bluepoint Games was released April 8, 2014. The game was highly anticipated as the debut title from developers formerly behind the successful Call of Duty franchise.
In Titanfall, players control "pilots" and their mech-style Titans, and fight in six-on-six matches set in war-torn outer space colonies. The game is optimized for fast-paced, continual action, aided by wall-running abilities and populations of computer-controlled soldiers.</p>
<br>
					<div>
					...
					<div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="images/titanfall1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="images/titanfall2.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div>
	</div>
