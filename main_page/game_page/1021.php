...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Sniper: Ghost Warrior 3</h1>

			<div class="product">
				
				    <iframe width="680" height="345" src="https://www.youtube.com/embed/Zq4Gxzge9Fc" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.in/Sniper-Ghost-Warrior-Season-Pass/dp/B01N5JFDWH" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p>Sniper: Ghost Warrior 3 is a tactical shooter video game developed and published by CI Games for Microsoft Windows, PlayStation 4 and Xbox One, and was released worldwide on 25 April 2017. It is also the first game in the series to feature an open world environment.</p>
<br>
					<div>
					...
					<div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="images/Snipergw31.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="images/Snipergw32.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div>
	</div>
