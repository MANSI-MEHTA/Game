...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Midnight Club 2</h1>

			<div class="product">
				
				    <iframe width="680" height="345" src="https://www.youtube.com/embed/mheTqhMLpL0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.com/Midnight-Club-2-PC/dp/B00008JOLT" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p>Midnight Club II is a racing video game developed by Rockstar San Diego and published by Rockstar Games. It is the sequel to Midnight Club: Street Racing, published for the PlayStation 2, Xbox and Microsoft Windows and first in series to feature motorcycles. Players can race through cities based on Los Angeles, Paris, and Tokyo. The game also features an online multiplayer component. It is the second game in Midnight Club franchise.</p>
<br>
					<div>
					...
					<div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="images/Midnightclub21.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="images/Midnightclub22.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div>
	</div>
