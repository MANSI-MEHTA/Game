...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Motogp 16</h1>

			<div class="product">
				
					<iframe width="680" height="345" src="https://www.youtube.com/embed/TV1wP13Vb80" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				...
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.in/Valentino-Rossi-Game-MotoGP16-PC/dp/B01EA8SSUG" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p>Valentino Rossi: The Game is a motorcycle racing video game developed and published by Milestone S.r.l.. The game was released for Microsoft Windows, PlayStation 4, and Xbox One on 16 June 2016. It is the official video game of the 2016 MotoGP season. The game is also endorsed by Italian professional motorcycle racer and multiple MotoGP World Champion Valentino Rossi.</p>
<br>
					<div>
					...
					<center><div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="motogp1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="motogp2.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div></center>
	</div>
