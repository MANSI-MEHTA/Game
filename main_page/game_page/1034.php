...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Motogp 17</h1>

			<div class="product">
				
					<iframe width="680" height="345" src="https://www.youtube.com/embed/mQyvTZFD5JQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				...
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.in/Milestone-MotoGP-17-PS4/dp/B06XRVPBCQ" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p> Prepare yourself for the adrenaline of the 2017 MotoGP. Enjoy all the bikes, teams and tracks of the official Championship. Try the new Managerial Career mode and put yourself in the shoes of a team manager, trying to make the right choices both on the track and off it.</p>
<br>
					<div>
					...
					<center><div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="motogp17 1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="motogp172.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div></center>
	</div>
