...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Horizon Zero Dawn</h1>

			<div class="product">
				
					<iframe width="680" height="345" src="https://www.youtube.com/embed/Dh_muRtr6iM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				...
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.in/Sony-Horizon-Zero-Dawn-PS4/dp/B06VV22K8R" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p>The plot revolves around Aloy, a hunter and archer living in a world overrun by machines. Having been an outcast her whole life, she sets out to discover the dangers that kept her sheltered. The player uses ranged weapons and a spear and stealth tactics to combat the mechanised creatures, whose remains can be looted for resources. A skill tree provides the player with new abilities and passive bonuses. The game features an open world environment for Aloy to explore, while undertaking side and main story quests. </p>
<br>
					<div>
					...
					<center><div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="horizonzero1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="horizonzero2.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div></center>
	</div>
