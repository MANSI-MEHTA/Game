...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Uncharted 3: Drake's Deception</h1>

			<div class="product">
				
					<iframe width="680" height="345" src="https://www.youtube.com/embed/tqJR4NpxtlM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				...
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="https://www.amazon.in/Uncharted-3-Drakes-Deception-PS3/dp/B0078JXD5A" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p>The game follows Nathan Drake who, with his mentor Victor Sullivan, travels the world in search of the legendary lost city the Iram of the Pillars in the Rub' al Khali desert.The plot draws from the archaeology days of T. E. Lawrence.Drake's Deception was the last Uncharted game developed under writer and creative director Amy Hennig.</p>
<br>
					<div>
					...
					<center><div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="uncharted1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="uncharted2.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div></center>
	</div>
