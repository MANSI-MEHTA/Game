...
<body>
	...
	<h1></h1>
		...
		<div class="container">
			...
			<h1 align="center">Into The Breach</h1>

			<div class="product">
				
					<iframe width="680" height="345" src="https://www.youtube.com/embed/3w67PcNhoWQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				...
				<div class="product-info">
					...
					<center><p><span>Buy at : 
						...
						<a href="http://store.steampowered.com/app/590380/Into_the_Breach/" target="_blank"><img src="http://www.niftybuttons.com/amazon/amazon-button1.png" alt="Amazon Button (via NiftyButtons.com)"></a></p></span>
			...
			<div class="accordion">
				<section class="ac-container">
					...
					<br>
<p>Into the Breach is set in the far future where humanity fights against an army of giant monsters collectively called the Vek. To combat them, the player controls soldiers that operate giant mechs that can be equipped with a variety of weapons, armor, and other equipment. The game uses a turn-based combat system, allowing the player to coordinate the actions of their team in response to enemy moves and actions that serve to telegraph their attacks.[1]</p>
<br>
					<div>
					...
					<center><div class="accordion-image">
								<div class="ac-img">
									<img height="200" width="250" src="intothebreach1.jpg" alt="Ferrari">
								</div>
								<div class="ac-img">
									<img height="200" width="250" src="intothebreach2.jpg" alt="Ferrari">
								</div>
								<div class="clear"></div>
							</div></center>
	</div>
