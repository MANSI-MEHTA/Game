...
<head>
	...
	function pickImageFrom(whichGallery)
	{
		...
		document.write('<a href="' + gallery[whichGallery][idx][1] + '"><img width="250" height="200" src="game_page/' + gallery[whichGallery][idx][0]+'"></a>');
	}
        </script>
	...
	<div class="portfolio" id="gallery">
		<div class="container">
			...
			<ul class="simplefilter w3layouts agileits">
				...
				<li class="w3layouts agileits" data-filter="1">Sports</li>
				<li class="w3layouts agileits" data-filter="2">Shooting</li>
				<li class="w3layouts agileits" data-filter="3">Racing</li>
				<li class="w3layouts agileits" data-filter="4">Action-adventure</li>
				<li class="w3layouts agileits" data-filter="5">Strategy</li>
			</ul>
